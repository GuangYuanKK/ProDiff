...
from prodiff.utils.base_model import BaseModel
from torch.nn import functional as F
from functools import partial
import numpy as np
from prodiff.utils.beta_schedule import make_beta_schedule, default
from ldm.ddpm import DDPM


@MODEL_REGISTRY.register()
class ProDiff_S2(BaseModel):
    """HI-Diff model for test."""

    def __init__(self, opt):
        super(ProDiff_S2, self).__init__(opt)
    ...
    def optimize_parameters(self, current_iter, noise=None):
        ...
        # ir
        self.output = self.net_g(self.lq, prior, self.coord, self.cell)
        ...
        if hasattr(self, 'net_g_ema'):
            ...
            if self.apply_ldm:
                ...
                with torch.no_grad():
                    ...
                    self.output = self.net_g(img, prior,self.coord, self.cell)
                    self.diffusion.train()
